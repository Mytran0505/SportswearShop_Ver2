...
namespace SportswearShop_Ver2.Controllers
{
    public class OrderController : Controller
    {
        ...
        public string get_product(int ProductId)
        {
            ...
            string output = $"<p><b style='font-size:20px'>ĐÁNH GIÁ SẢN PHẨM #{product.Id}</b></p><img src='/public/images_upload/product/{product.Image}'  style='margin: auto; max-width: 100px; max-height: 80px; width: auto; height: auto;'/>";
